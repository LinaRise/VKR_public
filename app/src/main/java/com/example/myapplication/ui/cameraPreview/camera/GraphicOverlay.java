...
public class GraphicOverlay<T extends com.example.myapplication.ui.cameraPreview.camera.GraphicOverlay.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@linkcom.example.myapplication.ui.cameraPreview.camera.GraphicOverlay.#add(Graphic)}.
     */
    public static abstract class Graphic {
        private com.example.myapplication.ui.cameraPreview.camera.GraphicOverlay mOverlay;

        public Graphic(com.example.myapplication.ui.cameraPreview.camera.GraphicOverlay overlay) {
            mOverlay = overlay;
        }
